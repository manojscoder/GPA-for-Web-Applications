...
<head>
	...
	<script>
		...
		{
			window.location.href = "logged_in.php?var="+CryptoJS.SHA1('http://localhost/Gra/Graph/log_in/'+img);
		}
	</script>
      <style>
      #my-image:hover {
...
//Getting layer2 image from previous form.
$var=$_GET['var'];
			...
			<div class="login_info">
				...
				<center>
                  <?php
                        ...
                        $sql = "SELECT image3 FROM major_project WHERE email='$email'";
                        ...
                        //Storing image1 details for final verification.
                        $_SESSION['a'][6]=$newArray[$a];
                        $_SESSION['layer3_a']=$newArray[$a];
                        //End.
