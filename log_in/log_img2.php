...
<head>
	...
	<script>
		...
		{
			var name = img.src;
			window.location.href = "log_img3.php?var="+CryptoJS.SHA1('http://localhost/Gra/Graph/log_in/'+img); 
		}
	</script>
      <style>
      #my-image:hover {
...
//Getting layer1 image from previous form.
$var=$_GET['var'];
			...
			<div class="login_info">
				...
				<center>
                  <?php
                        ...
                        $sql = "SELECT image2 FROM major_project WHERE email='$email'";
                        ...
                        $_SESSION['a'][4]=$newArray[$a];
                        $_SESSION['layer2_a']=$newArray[$a];
                        //End.
