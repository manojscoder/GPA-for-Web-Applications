...
<head>
	...
	<link href="css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
      ...
      <script>
            //Passing image 3 to next layer.
            function changeIt(img)
            {
                  window.location.href="registered_update.php?var="+CryptoJS.SHA1('http://localhost/Gra/Graph/log_in/'+img);
            }
      </script>
 <style>
      #my-image:hover {
...
//Getting image2 from previous layer.
$var=$_GET['var'];
$_SESSION['b'][2]=$_GET['var'];	
$_SESSION['new_layer2']=$_GET['var'];
//End.
